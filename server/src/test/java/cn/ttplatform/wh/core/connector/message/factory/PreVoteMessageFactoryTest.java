 ...
 */
@Slf4j
public class PreVoteMessageFactoryTest {

    PreVoteMessageFactory factory;

    @Before
    public void setUp() throws Exception {
        Pool<LinkedBuffer> pool = new FixedSizeLinkedBufferPool(10);
        factory = new PreVoteMessageFactory(pool);
    }
    ...
    public void create() {
        PreVoteMessage message = PreVoteMessage.builder()
            .term(0).lastLogTerm(0).lastLogIndex(0).sourceId("A").nodeId("A").build();
